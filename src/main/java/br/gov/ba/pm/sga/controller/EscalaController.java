...
import br.gov.ba.pm.sga.service.EscalaService;
import br.gov.ba.pm.sga.service.FuncaoService;
import br.gov.ba.pm.sga.service.GrupoServicoService;
import br.gov.ba.pm.sga.service.IntegranteService;
import br.gov.ba.pm.sga.service.PostoService;
import br.gov.ba.pm.sga.service.TipoServicoService;
...
public class EscalaController {
	...
	public ModelAndView add(@RequestParam("id") Long id, 
		...
		//integrante.setAluno(alunoService.findOne((int)(Long)aluno));
